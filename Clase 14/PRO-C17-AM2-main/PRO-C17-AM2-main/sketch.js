...
function preload(){
  ...
  volando = loadAnimation("pajarito.png","pajarito2.png")
...
function setup(){
 ...
 pajaros = createSprite(300,150,20,20)
...
if(gameState === "playing"){
  piso.velocityX = -(8 + 5*marcador/50)
  ...
  if(keyDown("space") && dinosaurio.y >= 156){
    dinosaurio.velocityY = -10
}
nubesIn()
obstaculosIn()
dinosaurio.velocityY += 0.7
...
nubes.velocityX = -(3+5*marcador/50)
...
if(frameCount%50 === 0){
  ...
  nubes.velocityX = -(5+2*marcador/100)
  nubes.addImage("movimiento", nubeImagen)
...
obstaculo.velocityX = -(8+2*marcador/100)
obstaculo.scale = 0.6
...
dinosaurio.changeImage("choco",dino2)
